...
THREE_AXIOMS = {
    "axiom1": {
        "name": "完备性约束",
        "formula": "theta_M + theta_C + theta_I = 90°",
        "description": "三扇区角度和恒为90度",
    },
    "axiom2": {
        "name": "六项作用量",
        "formula": "S(theta) = sum_{i=M,C,I} 1/sin^2(theta_i) + sum_{i<j} 1/(sin(theta_i)*sin(theta_j))",
        "description": "作用量由三扇区角度的三角函数构成",
    },
    "axiom3": {
        "name": "质量映射",
        "formula": "m_e = K * sin^3(theta_M)",
        "description": "电子质量由物质界角度的三次正弦映射",
    },
}

# 公理层文章编号前缀（主库AI只读这些 + 已验证主库公式）
