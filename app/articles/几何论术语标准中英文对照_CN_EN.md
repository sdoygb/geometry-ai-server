...
- 本次修改（260701.9 术语批次更新）：新增 ℰ 映射锚点（§3）、桥接函数标准形（§4）；更新九素互扼出处（§8）；新增禁用词"桥接公理""九素互扼定理"（§10）
