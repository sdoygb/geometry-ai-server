...
> **语言**：中文 / English  
> **更新规则**：见 §11 维护规则  
> **本次更新**：全库版本统一至 260707.7（79 篇 0.X 系列及应用篇依赖版本号全部统一）；应用篇扩展至 62 篇（新增 51–62 号：重子生成、原初核合成、中微子绝对质量、暗物质替代、PMNS、磁单极子、三代起源、夸克禁闭、引力统一、家族对称性、规范群根源、生物诞生与进化）；0.0.0《零与谱》第二版同步——新增谱展开、谱权重 6:2:1；0.0.0 退为纯数学推演，不界定公理层级；新增六项无量纲代价函数、严格凸性等术语；§1 公理体系重构以兼容 0.0.0 底层框架
