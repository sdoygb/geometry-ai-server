...
| 0.2 | 互锁常数 | $\Lambda(S_3) = 3$ | [Λ=3（GT-0.2.0.4）](./0.2_谱展开与互锁常数_CN_260713.1.md#GT-0.2.0.4) |
| 0.2 | 紧致常数 | $k_0(S_3) = 2$ | [k₀=2（GT-0.2.0.5）](./0.2_谱展开与互锁常数_CN_260713.1.md#GT-0.2.0.5) |
| 0.2 | 半径比 | $r_M : r_C : r_I = 1 : 1/\sqrt{3} : 1/\sqrt{6}$ | [半径比（GT-0.2.0.6）](./0.2_谱展开与互锁常数_CN_260713.1.md#GT-0.2.0.6) |
| 0.3 | 公理1（三分连续化） | 谱层级→三个连续角度参数 $\theta_M, \theta_C, \theta_I$ | [三分切丛分解（GT-0.3.0.1）](./0.3_三公理_CN_260713.1.md#GT-0.3.0.1) |
| 0.3 | 公理2（乘积球面几何） | $M(a) = S^3 \times S^3 \times S^3$，半径比固定 | [M(a)约束等谱刚性（GT-0.3.0.3）](./0.3_三公理_CN_260713.1.md#GT-0.3.0.3) |
| 0.3 | 公理3（全息屏约束） | $\theta_M + \theta_C + \theta_I = 90^\circ$ | [公理3：全息屏编码条件（GT-0.3.0.6）](./0.3_三公理_CN_260713.1.md#GT-0.3.0.6) |
