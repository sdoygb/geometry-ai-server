...
> **语言**：中文 / English  
> **更新规则**：见 §11 维护规则  
> **本次更新**：第三轮——S1–S9缺口封闭新增术语，来自：50号（早期宇宙）、51号（重子生成）、52号（原初核合成）、53号（中微子绝对质量标度）、54号（暗物质替代完整论证）、55号（PMNS混合矩阵）、56号（磁单极子）、4号（电弱crossover §5.3）、5号（强CP §5.5）、0.6.7（三代起源 §6.4）。累计约60个新术语录入，术语表总条目突破400
