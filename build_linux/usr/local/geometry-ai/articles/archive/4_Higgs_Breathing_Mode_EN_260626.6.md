...
- Chapter 3　Geometric Derivation of the Potential Terms
  ...
  - §3.4　Potential Coefficient Locking and Honest Labeling
...
- Chapter 5　Complete Lagrangian and Comparison with the Standard Model
  - §5.1　Rigorous Assembly and Honest Labeling
...
**Axiom 2 (Six-Term Action Axiom, 0.0.7/0.2.1)**:
...
**Honest Labeling**: The correspondence $\delta S = -\Phi$ is the core input for the assembly of the potential terms in this paper. Its rigorous proof requires further axiomatization of the information field encoding of 0.2.2. It is currently a **constructive assumption**, not a rigorous theorem.
...
**Honest Labeling**: All derivations below that depend on $H_{ij}(\Phi) = H_{ij}^{(0)}(1 + \Phi/S_0)$ (including the cubic and quartic potential terms) are premised on this constructive hypothesis.
...
**Honest Labeling**: Not an independent rigorous theorem. Depends on Constructive Hypothesis 2.2 and Proposition 2.1.
...
**Honest Labeling**: Same as Constructive Hypothesis 3.2; depends on Constructive Hypothesis 2.2 and Proposition 2.1.
...
**Honest Labeling**: $\mathcal{L}_{\text{kin}} = \frac{1}{2}(\partial_\mu\Phi)^2$ as the 4D kinetic term is a **conditional framework**, not a rigorous theorem. The 2D kinetic term (Theorem 4.2) is a rigorous theorem.
...
**Honest Labeling**: The rigorous geometric origin of $\mathcal{N}_\Sigma = \pi/\sqrt{8}$ is a **pending closure item**. Until a rigorous derivation is completed, this paper labels it as a "constructive normalization convention." Fine-tuning this factor can alter the output value of $m_H$ — it is not currently a rigid prediction.
...
| Infiltration functions $\eta_M,\eta_C,\eta_I$ | Breathing mode couples via $\det H$ | Indirect |
...
[9] 0.2.1.1(260626.6)　Analytic Framework for the Infiltration Function
...
- **260626.6**: Comprehensive revision. Major changes:
  ...
  2. Corrected reference [12]: changed the original "0.2.4 Infiltration Functions and Cross-Sector Coupling" to "0.2.4 Chemical Mapping"; the correct article for infiltration functions is 0.2.1.1 (reference [9]);
  ...
  5. Added four-tier honest labeling throughout the paper: theorem / constructive assumption / conditional framework / working hypothesis;
