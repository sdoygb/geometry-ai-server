...
## 十七、应用篇——创世与宇宙演化 / XVII. Applications — Genesis & Cosmic Evolution
...
## 十八、应用篇——生命科学与人体 / XVIII. Applications — Life Sciences & Human Body
...
## 十九、应用篇——凝聚态与工程 / XIX. Applications — Condensed Matter & Engineering
...
## 二十、符号硬约束 / XX. Symbol Format Hard Constraints
...
## 二十一、翻译风格约定 / XXI. Translation Style Conventions
...
| 人名（Atiyah, Wodzicki, Bott） / Personal names | 保持原拼写 / Retain original spelling |
| 标准数学术语（Hessian, Dirac, Laplace-Beltrami） / Standard math terms | 使用标准译法 / Use standard translations |
...
> **使用说明 / Usage Note**：本表为草案 v1。凡标 ⚡ 的需人工审定。审定后可将本表作为所有翻译任务的强制性前置规范。新出现的术语应遵循命名模式（如 X 界→X-Realm/X-Sector、X 定理→X Theorem）并同步加入本表。
> / This table is Draft v1. Items marked ⚡ require author review. After review, this table shall serve as the mandatory pre-translation standard for all translation tasks. Newly emerging terms shall follow the naming pattern (e.g., X 界→X-Realm/X-Sector, X 定理→X Theorem) and be added to this table synchronously.
