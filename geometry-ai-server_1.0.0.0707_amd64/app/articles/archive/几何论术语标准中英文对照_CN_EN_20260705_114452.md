...
> **语言**：中文 / English  
> **更新规则**：见 §11 维护规则  
> **本次更新**：0.0.0《零与谱》第二版同步——新增谱展开、谱权重 6:2:1；0.0.0 退为纯数学推演，不界定公理层级；新增六项无量纲代价函数、严格凸性等术语；§1 公理体系重构以兼容 0.0.0 底层框架

---

## §1 公理体系

> 公理 = 理论的全部自由输入。几何论的**公理体系**集中于 **0.0.3–0.0.7**（圆拓扑 + 边界极限 + 全息屏编码条件）。**0.0.0《零与谱》**为纯数学推演，提供 $S_3$ 谱权重 $6:2:1$，不作公理或定理界定。
>
