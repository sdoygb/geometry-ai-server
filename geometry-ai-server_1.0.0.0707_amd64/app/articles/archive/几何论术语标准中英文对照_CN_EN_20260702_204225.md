...
> **语言**：中文 / English  
> **更新规则**：见 §11 维护规则  
> **本次更新**：基于向量库全部约100篇文章的系统性扫描，新增术语覆盖 0.1.X–0.8.X 系列及应用篇 1–49 号
...
| 几何因子 $C_{\text{geo}}$ | Geometric Factor $C_{\text{geo}}$ | 信息场与几何结构耦合的无量纲因子 | 0.4.6 §1 |
...
| Hopf纤维化定理 | Hopf Fibration Theorem | 公理3的三分切丛结构可提升为 $S^3 \to S^2$ Hopf纤维化的完整拓扑描述（0.3.6）；Hopf假设的提出与验证（0.3.8） | 0.3.6 §2–§4, 0.3.8 §1 |
...
| 几何因子 $C_{\text{geo}}$ | Geometric Factor $C_{\text{geo}}$ | 信息场与几何耦合的无量纲因子，由约束截面谱决定 | 0.4.6 §1 |
...
| 几何因子 $C_{\text{geo}}$ | Geometric Factor $C_{\text{geo}}$ | 信息场-几何耦合无量纲因子 | 0.4.6 §1 |
...
| Hopf 假设 | Hopf Hypothesis | 公理3的三分切丛结构可通过 Hopf 纤维化完备描述的假设，非定理 | 0.3.8 §1 |
